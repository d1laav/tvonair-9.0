...
function App() {
  ...
  const showTeamMembers = (category) => {
    ...
    for (const coordinator of selectedCategory.coordinators) {
      const memberElement = `<tr><td class="px-4 py-3 text-center">${coordinator.name}</td></tr>`;
  ...
  const teamData = {
    BPH: {
      coordinators: [
        { name: "Marissa Amran", title: "Coordinator" },
        { name: "Betari Naratayaka", title: "Coordinator" },
        { name: "Prince Wiranata", title: "Coordinator" },
        { name: "Euginia", title: "Coordinator" },
        { name: "Audy Devanty", title: "Coordinator" },
      ],
      members: [
        { name: "", title: "" },
      ],
    ...
    Logistic: {
      coordinators: [
        { name: "Muhammad Redho Adastra", title: "Coordinator" },
        { name: "Scholastika Santa Aditya Hapsari", title: "Coordinator" },
      ],
      members: [
        { name: "Kenneth Wilbert", title: "" },
        { name: "Vic Adrian Terrance", title: "" },
        { name: "Carlencia Avelisca Chandra", title: "" },
        { name: "Sheena Tjhang", title: "" },
        { name: "Samuel Matthew Samadikun", title: "" },
        { name: "Devin Nathanael", title: "" },
        { name: "Samuel Wiratama", title: "" },
        { name: "Dixon Natanael ", title: "" },
        { name: "Hope T. Soelaiman", title: "" },
      ],
    },
    Publikasi: {
      coordinators: [
        { name: "Nisrina Shidqi Nabila", title: "Coordinator" },
        { name: "Cindy Celia Jennifer", title: "Coordinator" },
      ],
      members: [
        { name: "Feby Amelia A'la Tahta Abada", title: "" },
        { name: "Carolyn Kyneisha", title: "" },
        { name: "Michellin Ficella Chandra", title: "" },
        { name: "Hakam Natalegawa", title: "" },
        { name: "Miranda Putri Heryadi ", title: "" },
        { name: "Naila Callista Akbar", title: "" },
      ]
    },
    Visual: {
      coordinators: [
        { name: "Shavina Rahmalia ", title: "Coordinator" },
        { name: "Stevani", title: "Coordinator" },
      ],
      members: [
        { name: "Chelssy Djunfandi", title: "" },
        { name: "Valeria Angeline Rainie", title: "" },
        { name: "Fransiska Thalia Sadikin", title: "" },
        { name: "Florencia Elian", title: "" },
        { name: "Angela Felicia Florenza", title: "" },
        { name: "Jennifer Laurent Zhou", title: "" },
      ]
    },
    Acara: {
      coordinators: [
        { name: "Novryan Susanto", title: "Coordinator" },
        { name: "Lavia Jovelin", title: "Coordinator" },
      ],
      members: [
        { name: "Christian Aaron Satria ", title: "" },
        { name: "Mayang Cerana N", title: "" },
        { name: "Joevika Limtan", title: "" },
        { name: "Aisyah Luviola Hanum", title: "" },
        { name: "Cindy Aurellia Liwang", title: "" },
        { name: "Muhamad Ilham Rizky Ajie", title: "" },
        { name: "Kayfa Razqia Dey", title: "" },
        { name: "Theresa serena", title: "" },
      ]
    },
    Sponsor: {
      coordinators: [
        { name: "Aurellia Shabrina Nurfitriani", title: "Coordinator" },
        { name: "Hanif", title: "Coordinator" },
      ],
      members: [
        { name: "Florentinus Krisna", title: "" },
        { name: "Raihan Pratama Suhendra ", title: "" },
        { name: "Vania Gita Gunawan", title: "" },
        { name: "Stevany Anggelia", title: "" },
        { name: "Larissa Ika Kamila", title: "" },
        { name: "Alroy Reynardo Waruwu ", title: "" },
      ],
    },
    Media_Relation: {
      coordinators: [
        { name: "Maria Immaculata Caeli Porta ", title: "Coordinator" },
        { name: "Sinta Makdalena", title: "Coordinator" },
      ],
      members: [
        { name: "Stefanny Chandra", title: "" },
        { name: "Miranda Putri Heryadi", title: "" },
        { name: "Dianra Eka Novelina Siregar", title: "" },
        { name: "Axel Lionel Raphael ", title: "" },
        { name: "Annasya Rahmadina Fauziah", title: "" },
        { name: "Emily Fransisca Gouw", title: "" },
        { name: "Selvia Febriani", title: "" },
      ],
    },
    Fresh_Money: {
      coordinators: [
        { name: "Sheren Olivia", title: "Coordinator" },
        { name: "Catherine Margareta", title: "Coordinator" },
      ],
      members: [
        { name: "Vania Rizki Amelia", title: "" },
        { name: "Dean Yulista", title: "" },
        { name: "Kristiana Andrea Calista ", title: "" },
        { name: "Niki Efend", title: "" },
        { name: "Stevi Hansen Putr", title: "" },
        { name: "Angriany Lutfiyah Darmawan", title: "" },
        { name: "Andreas Clarence", title: "" },
        { name: "Michael Piong", title: "" },
        { name: "William Louwi", title: "" },
        { name: "Michelle Angelina Mark", title: "" },
      ],
    },
    IT: {
      coordinators: [
        { name: "David Immanuel", title: "Coordinator" },
        { name: "", title: "Coordinator" },
      ],
      members: [
        { name: "Caleb Steve Dinoto", title: "" },
        { name: "Rafael Natanael", title: "" },
        { name: "Malik Bazil Rabbani", title: "" },
      ],
    },
    Security: {
      coordinators: [
        { name: "Felicia Saimin", title: "Coordinator" },
        { name: "Andiaz Ramadhan Djohansyah", title: "Coordinator" },
      ],
      members: [
        { name: "Muhammad Alifio Rachman", title: "" },
        { name: "Dalvin", title: "" },
        { name: "Willbert Budi Lian", title: "" },
        { name: "Erika", title: "" },
        { name: "Kathleen Aurelia Chandra", title: "" },
        { name: "Vincent Kurniawan", title: "" },
        { name: "Deborah Priscilla Wijaya", title: "" },
        { name: "Jason Hartono", title: "" },
        { name: "Felicia Akiko Taslim", title: "" },
        { name: "Juniwerd Jonathan Sajangbati ", title: "" },
        { name: "Ferry Halim Putra", title: "" },
        { name: "Florencia Irena", title: "" },
        { name: "Jesslyn Trismi ", title: "" },
        { name: "Valentino Anwar", title: "" },
        { name: "Joshua Wijaya", title: "" },
        { name: "Cattie Meilisa Adestia", title: "" },
        { name: "Joshua Oliver", title: "" },
      ],
    },
    dokum: {
      coordinators: [
        { name: "Athaya Hana Mumtaza", title: "Coordinator" },
        { name: "Yovie Given Nata Widjaja", title: "Coordinator" },
      ],
      members: [
        { name: "Raden Mas Mario Wisnu Adityo Sasraningrat", title: "" },
        { name: "Vildan Prabaswara Anandanto", title: "" },
        { name: "Michael Chrisnanto Girsang", title: "" },
        { name: "Exan Putra Adityatama", title: "" },
        { name: "Fierzy", title: "" },
      ],
    },
      ...
      {loading ? (
        ...
        <>
         ...
         <Element name="divisions">
          <div ref={divisions} className="menu py-11 flex items-center justify-center py-auto px-auto bg-customYellow relative">
            {/* WAVE */}
            <div class="custom-shape-divider-top-1713002999">
          ...
          {/*anggota divisi */}
          <section className="text-gray-600 body-font relative bg-customYellow">
